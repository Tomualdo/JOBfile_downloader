...
def formating(jobNo):
    ...
    f = open('/home/tom/Projects/proface/robotFiles/'+directory+'/'+d1+'/ROB'+jobNo+'_'+d1+'.txt','rb')    
    l = list(f.read())
...
#                   /home/tom/Projects/proface/robotFiles/mainQl02/20200303
    ...
    nc = nclib.Netcat(('10.210.202.'+IP+'', 700), udp=True, verbose=0)
    ...
    rob = open('/home/tom/Projects/proface/robotFiles/'+directory+'/'+d1+'/ROB'+jobNo+'_'+d1+'.txt', 'wb')
    rob1 = nc.recvuntil(str.encode('  END'))
    rob.write(rob1)
    rob.close()
    ...
    stat = os.stat('/home/tom/Projects/proface/robotFiles/'+directory+'/'+d1+'/ROB'+jobNo+'_'+d1+'.txt')
    #stat = os.stat('/home/tom/Projects/proface/robotFiles/'+directory+'/'+d1+'/job'+jobNo+'_'+d1+'.txt')
    #print(stat.st_size)
    if stat.st_size <= 1:
        os.remove('/home/tom/Projects/proface/robotFiles/'+directory+'/'+d1+'/ROB'+jobNo+'_'+d1+'.txt')
    else:
